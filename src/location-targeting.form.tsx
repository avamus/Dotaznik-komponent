...
import StylizedUSAMap from '@/components/StylizedUSAMap'
      ...
      <form onSubmit={(e) => {
        ...
        <Card className="w-full max-w-4xl mx-auto p-4 sm:p-6 md:p-8 space-y-6 sm:space-y-8 bg-black/50 border-[#EECC6E]/20 shadow-2xl backdrop-blur-sm font-manrope">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
            <div>
              <Label htmlFor="firstName" className="text-[#EECC6E] text-base sm:text-lg font-manrope font-semibold mb-4"><span className="text-[#EECC6E]">* </span>First Name</Label>
              <Input
                id="firstName"
                name="firstName"
            ...
            <div>
              <Label htmlFor="lastName" className="text-[#EECC6E] text-base sm:text-lg font-manrope font-semibold mb-4"><span className="text-[#EECC6E]">* </span>Last Name</Label>
              <Input
                id="lastName"
                name="lastName"
            ...
            <div>
              <Label htmlFor="email" className="text-[#EECC6E] text-base sm:text-lg font-manrope font-semibold mb-4"><span className="text-[#EECC6E]">* </span>E-mail</Label>
              <Input
                id="email"
                name="email"
                type="email"
            ...
            <div>
              <Label htmlFor="phoneNumber" className="text-[#EECC6E] text-base sm:text-lg font-manrope font-semibold mb-4"><span className="text-[#EECC6E]">* </span>Phone Number</Label>
              <Input
                id="phoneNumber"
                name="phoneNumber"
                type="tel"
            ...
            <div className="sm:col-span-2">
              <Label htmlFor="campaignName" className="text-[#EECC6E] text-base sm:text-lg font-manrope font-semibold mb-4"><span className="text-[#EECC6E]">* </span>Name of your campaign</Label>
              <Input
                id="campaignName"
                name="campaignName"
                type="text"
          ...
          <div className="space-y-4 sm:space-y-6">
            <Label className="text-[#EECC6E] text-base sm:text-lg font-manrope font-bold tracking-tight mb-3"><span className="text-[#EECC6E]">* </span>Do you want to target locations by:</Label>
          ...
          {formState.targetingType === 'state' && (
            <div className="space-y-4 sm:space-y-6">
              <Label className="text-[#EECC6E] text-base sm:text-lg font-manrope font-bold tracking-tight mb-3"><span className="text-[#EECC6E]">* </span>Select By States</Label>
                    ...
                    <ScrollArea className="h-[200px] sm:h-[300px]">
                      {availableStates.map((state) => (
                        <SelectItem 
                          ...
                          disabled={formState.selectedStates.includes(state) && formState.selectedStates.length >= 5}
                        >
              ...
              <div className="space-y-4">
                <Label className="text-[#EECC6E] text-base sm:text-lg font-manrope font-bold tracking-tight mb-3">Select By Cities</Label>
                <p className="text-xs sm:text-sm text-gray-300 mb-2 sm:mb-4 font-manrope">
                      ...
                      <ScrollArea className="h-[200px] sm:h-[300px]">
                        {availableCities.map((city) => (
                          <SelectItem 
                            ...
                            disabled={formState.selectedCities.includes(city) && formState.selectedCities.length >= 10}
                          >
                            <div className="flex items-center justify-between w-full font-manrope">
                              <span>{city}</span>
                              {formState.selectedCities.includes(city) && (
          ...
          {formState.targetingType === 'zipCode' && (
            <div className="space-y-4">
              <Label className="text-[#EECC6E] text-base sm:text-lg font-manrope font-bold tracking-tight mb-3"><span className="text-[#EECC6E]">* </span>List the ZIP codes for your campaign target:</Label>
